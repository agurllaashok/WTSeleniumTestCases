 ...
 public String forgotPassword()
	{
		...
		//event creation 
			...
			public void evntcreationmultisubcattimeslot() throws InterruptedException, AWTException
			{
				...
				// js.executeScript("arguments[0].scrollIntoView();", paidName);
				 ...
				 //paid subcat2 paidtktstotal(gold)
				 driver.findElement(paidsubcatadd).click();
				 Thread.sleep(2000);				
				 ...
				 //paid subcat2 paidtktstotal(silver)
				 driver.findElement(paidsubcatadd2).click();
				 Thread.sleep(2000);				
